                    ...
                    <nav id="navbar" className="navbar order-last order-lg-0">
                        <ul>
                            ...
                            <li>
                                ...
                                <NavLink exact className="nav-link scrollto active" to={"/depatment"}>Departments</NavLink>
                                </li>
                            <li>
                                {/* <a className="nav-link scrollto" href="./pages/doctors.html">Doctors</a> */}
                                <NavLink exact className="nav-link scrollto active" to={"/doctor"}>Doctors</NavLink>
                            </li>
                            <li>
                                {/* <a className="nav-link scrollto " href="./pages/about.html">About</a> */}
                                <NavLink exact className="nav-link scrollto active" to={"/about"}>About</NavLink>
                                </li>
                            <li>
                                {/* <a className="nav-link scrollto" href="./pages/contact.html">Contact</a> */}
                                <NavLink exact className="nav-link scrollto active" to={"/contact"}>Contact</NavLink>
                            </li>
                        </ul>
